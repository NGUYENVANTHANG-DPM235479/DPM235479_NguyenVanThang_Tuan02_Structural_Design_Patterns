...
{
    public class PhanBon : ISanPham
    {
        public string TenSanPham { get; set; }
        public decimal GiaNhap { get; set; }
        public int SoLuongTon { get; set; }
        public decimal ChiPhiVanChuyenRieng { get; set; } // Chi phí vận chuyển phụ phát sinh

        public void Accept(IBaoCaoVisitor visitor)
        {
            // Chuyển hướng Visitor đến đúng hàm xử lý dành riêng cho Phân Bón
